...
const Header = () => {
	...
	return (
		<GridContainer container alignContent={'center'} p={4} spacing={4}>
			<GridItem item xs={12} md={2} sx={{ textAlign: { xs: 'center' } }}>
				<Box component='img' maxWidth={'70%'} alt='Logo' src={Logo} />
			</GridItem>
			<Grid
				container
				item
